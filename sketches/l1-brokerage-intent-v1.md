...
- **L1.placement-moment** — A trade is placed at the moment of the earliest report of it held by the brokerage, as that report states its own time. A later report of a trade the brokerage has not seen before is treated as its placement and marked as first seen late, so the ownership it fixes can be reviewed. (Assumed under `issue-8-statement-content-assumed`; review trigger: the business confirms or amends.)
