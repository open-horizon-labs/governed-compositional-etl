...
- **L1.hole.trade-timestamps** — Which moment counts as "when the trade was placed" and "when it completed" when a later report of a trade arrives without its full history?
