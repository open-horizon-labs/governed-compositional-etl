...
The issue #3 [semantic repair oracle](docs/semantic-repair-oracle.md) freezes policy-authorized local, edge/composition, and ambiguous cases plus narrative-free scoring before experiment execution.
